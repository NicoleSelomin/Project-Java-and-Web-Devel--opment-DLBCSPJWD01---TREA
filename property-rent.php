...
<head>
    ...
    <title>Properties for Rent | TREA</title>
...
<main class="container py-5 flex-grow-1">
    ...
    <div class="mb-4 p-3 border rounded shadow-sm text-center main-title bg-white">
        <h2 class="mb-2">Available Properties for Rent</h2>
        <p class="text-muted mb-0 fs-6">Browse managed and brokerage rental listings.</p>
    </div>
    ...
    <?php if (empty($properties)): ?>
        <div class="alert alert-warning text-center">No rental properties found. Try adjusting your filters or check back soon!</div>
    <?php else: ?>
                        ...
                        <a href="view-property.php?property_id=<?= $property['property_id'] ?>" class="text-decoration-none text-dark">
                            <h5 class="card-title mb-1">
                                ...
                                <?php elseif ($property['service_slug'] === 'rental_property_management'): ?>
                                    <span class="badge bg-success ms-1" data-bs-toggle="tooltip" title="Managed: TREA manages the entire process.">Managed</span>
                                <?php endif; ?>
                            </h5>
                        </a>
